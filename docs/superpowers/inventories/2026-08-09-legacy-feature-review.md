...
| Ever Grande Old Lady interaction | [`ever-grande-old-lady-interaction`](#feature-manifest) — Ever Grande and Route 111 Old Lady Rest Stop map JSON | Current map JSON/event sources | Modern adaptation | 2 | `1bcac4480d` assigns the Route 111 Old Lady interaction script to an Ever Grande NPC; retain that authored interaction while keeping current empty-event JSON formatting for the Rest Stop. Verify the Ever Grande NPC dialogue and Rest Stop traversal. |
...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"ever-grande-old-lady-interaction","legacy_paths":[{"category":"maps-and-events","prefixes":["data/maps/EverGrandeCity/map.json","data/maps/Route111_OldLadysRestStop/map.json"]}],"target_paths":["data/maps/EverGrandeCity/map.json","data/maps/Route111_OldLadysRestStop/map.json","current Old Lady script source"],"decision":"Modern adaptation","phase":2,"status":"planned","behavior":"Ever Grande NPC runs the Route 111 Old Lady interaction; Rest Stop preserves valid empty event collections.","dependencies":["current map JSON and script pipeline"],"validation":["talk to Ever Grande NPC", "enter/exit Route 111 Old Lady Rest Stop", "supported build"],"evidence":["git show 1bcac4480d -- data/maps/EverGrandeCity/map.json data/maps/Route111_OldLadysRestStop/map.json"]},
