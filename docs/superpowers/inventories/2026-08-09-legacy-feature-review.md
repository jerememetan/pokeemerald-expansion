...
| Seven custom move animations | [`c73e-move-animations`](#feature-manifest) — battle animation scripts and move data | Current battle-animation and move-data sources | Modern adaptation | 4 | `c73e48076b` adds animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, and Rage Fist. Recreate those move-to-animation bindings on current interfaces and verify each in battle. |
