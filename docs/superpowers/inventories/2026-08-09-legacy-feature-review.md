...
| Current move animations, Torque updates, and Psychic Noise effect | [`c73e-move-animations`](#feature-manifest) — legacy battle animation scripts, move data, and descriptions | Current 1.16.3 battle-animation and `src/data/moves_info.h` | Use upstream equivalent | 4 | Use 1.16.3's animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, Chilling Water, Spicy Extract, Glaive Rush, and Blazing/Wicked/Noxious/Combat/Magical Torque. The V2.6 Population Bomb two-slice correction and Pounce redirect are superseded by current implementations. Per user policy, retain current Torque `---` descriptions and Psychic Noise healing prevention. |
...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"c73e-move-animations","legacy_paths":[{"category":"gameplay-and-battle","prefixes":["data/battle_anim_scripts.s","src/data/battle_moves.h","src/data/text/move_descriptions.h"]}],"target_paths":["data/battle_anim_scripts.s:gBattleAnimMove_SpicyExtract","data/battle_anim_scripts.s:gBattleAnimMove_PopulationBomb","data/battle_anim_scripts.s:gBattleAnimMove_GlaiveRush","data/battle_anim_scripts.s:gBattleAnimMove_Pounce","data/battle_anim_scripts.s:gBattleAnimMove_CollisionCourse","data/battle_anim_scripts.s:gBattleAnimMove_ElectroDrift","src/data/moves_info.h"],"decision":"Use upstream equivalent","phase":4,"status":"planned","behavior":"Use current 1.16.3 animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, Chilling Water, Spicy Extract, Glaive Rush, and all five Torque moves. V2.6 adds Spicy Extract's orange poison-bubble/ten-projectile red-impact sequence; current gBattleAnimMove_SpicyExtract supplies it. V2.6's Population Bomb follow-up calls both cut directions, while current intentionally chooses one randomized cut. V2.6's Glaive Rush is a high-speed sword/glaive charge-and-impact sequence; current supplies that dedicated sequence. V2.6 redirects Pounce through BounceUnleash, while current retains its dedicated hop, impact, and return. V2.6 also revises Collision Course's charge/impact and Electro Drift's electric palette effects; current dedicated scripts supersede them. Deliberately retain current Torque `---` descriptions and Psychic Noise healing prevention.","dependencies":["current battle animation engine","src/data/moves_info.h move-to-animation bindings"],"validation":["Spicy Extract shows orange poison projectiles and red target impact","Population Bomb uses current randomized cutting-slice animation","Glaive Rush shows current high-speed sword/glaive charge and impact","Pounce shows current hop, target impact, and return","Collision Course and Electro Drift run their current dedicated animations","confirm all five current Torque descriptions are `---`","confirm Psychic Noise healing prevention","supported build"],"evidence":["git show 63ee560037 -- data/battle_anim_scripts.s","git show 4615c4fa91 -- data/battle_anim_scripts.s","git show a86f9d6442 -- data/battle_anim_scripts.s","current data/battle_anim_scripts.s defines gBattleAnimMove_SpicyExtract, gBattleAnimMove_PopulationBomb, gBattleAnimMove_GlaiveRush, gBattleAnimMove_Pounce, gBattleAnimMove_CollisionCourse, and gBattleAnimMove_ElectroDrift","current src/data/moves_info.h binds all six moves to those scripts","user policy: prefer current 1.16.3 animations where present","user decision: retain current 1.16.3 Torque descriptions"]},
