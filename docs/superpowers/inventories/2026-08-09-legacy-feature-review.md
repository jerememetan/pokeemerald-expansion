...
<!-- feature-manifest
{
  "features": [
    ...
    },
    {
      ...
      "legacy_paths": [{"category": "tooling-and-generated-output", "prefixes": [""], "exclude_prefixes": ["data/scripts/players_house.inc", "data/scripts/item_ball_scripts.inc"]}],
