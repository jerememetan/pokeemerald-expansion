...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"c73e-move-animations","legacy_paths":[{"category":"gameplay-and-battle","prefixes":["data/battle_anim_scripts.s","src/data/battle_moves.h"]}],"target_paths":["data/battle_anim_scripts.s","src/data/moves_info.h","current battle animation sources"],"decision":"Use upstream equivalent","phase":4,"status":"planned","behavior":"Use the current 1.16.3 animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, and Chilling Water. Use the current 1.16.3 Psychic Noise behavior rather than the legacy move-table implementation.","dependencies":["current battle animation engine","current move data"],"validation":["confirm each listed move has a current animation without importing legacy scripts","confirm current src/data/moves_info.h assigns Psychic Noise EFFECT_HEAL_BLOCK","supported build"],"evidence":["user decision: prefer 1.16.3 animations and Psychic Noise mechanics","src/data/moves_info.h defines MOVE_PSYCHIC_NOISE with EFFECT_HEAL_BLOCK","git show c73e48076b -- data/battle_anim_scripts.s src/data/battle_moves.h"]},
