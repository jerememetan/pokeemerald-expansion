...
| Current move animations, Torque updates, and Psychic Noise effect | [`c73e-move-animations`](#feature-manifest) — legacy battle animation scripts, move data, and descriptions | Current 1.16.3 battle-animation, move-data, and description sources | Use upstream equivalent | 4 | Use 1.16.3's animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, Chilling Water, and Blazing/Wicked/Noxious/Combat/Magical Torque. Use current Torque descriptions and Psychic Noise healing-prevention behavior. |
...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"c73e-move-animations","legacy_paths":[{"category":"gameplay-and-battle","prefixes":["data/battle_anim_scripts.s","src/data/battle_moves.h","src/data/text/move_descriptions.h"]}],"target_paths":["data/battle_anim_scripts.s","src/data/moves_info.h","src/data/text/move_descriptions.h"],"decision":"Use upstream equivalent","phase":4,"status":"planned","behavior":"Use current 1.16.3 animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, Chilling Water, and all five Torque moves; use current Torque descriptions and Psychic Noise healing prevention.","dependencies":["current battle animation engine","current move data and descriptions"],"validation":["confirm each listed move, including all five Torque moves, has a current animation","confirm current Torque descriptions","confirm Psychic Noise healing prevention","supported build"],"evidence":["user decision: prefer 1.16.3 animations and Psychic Noise mechanics","git show e6c3bf419f -- data/battle_anim_scripts.s src/data/text/move_descriptions.h","current move-data/description sources"]},
    ...
    {"id":"level-cap-progression","legacy_paths":[{"category":"gameplay-and-battle","prefixes":["src/battle_script_commands.c","include/event_data.h"]}],"target_paths":["src/battle_script_commands.c","include/event_data.h","include/config/level_caps.h"],"decision":"Modern adaptation","phase":4,"status":"planned","behavior":"Preserve pre-cap XP reduction and post-Lilycove cap progression.","dependencies":["current level-cap configuration and event flags"],"validation":["XP below/at cap", "post-Lilycove cap flag", "supported build"],"evidence":["git show 0080ad90f7 -- src/battle_script_commands.c include/event_data.h","0080ad90f7 commit message"]},
    {
      ...
      "legacy_paths": [{"category": "gameplay-and-battle", "prefixes": [""], "exclude_prefixes": ["src/data/battle_frontier/battle_frontier_mons.h", "src/data/battle_frontier/battle_frontier_trainer_mons.h", "src/battle_tower.c", "include/constants/battle_frontier.h", "src/data/trainer_parties.h", "src/data/trainers.h", "include/config/battle.h", "include/constants/flags.h", "include/constants/opponents.h", "src/battle_main.c", "src/data/wild_encounters.json", "src/berry.c", "src/battle_script_commands.c", "include/event_data.h", "data/battle_anim_scripts.s", "data/battle_scripts_1.s", "src/data/battle_moves.h", "src/data/text/move_descriptions.h", "src/ui_startmenu_full.c", "src/pokedex_plus_hgss.c", "include/start_menu.h", "include/ui_startmenu_full.h"]}],
