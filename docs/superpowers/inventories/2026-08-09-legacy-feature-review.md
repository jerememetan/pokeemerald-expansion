...
| Dialogue corrections | [`dialogue-corrections`](#feature-manifest) — Fortree Gym and Route 120 Poryscript sources; related generated/map/trainer files remain with their established owners | Current map script sources and generated text | Modern adaptation | 2 | `19b9449e16` makes the Fortree Gym Guide warn that Winona uses Double Battles and corrects the Route 120 gate condition to require beating Winona. Also retain the Mom and Route 122 paragraph breaks, Leaf’s Red-focused post-battle text, and Mom’s Pokémon Breeder F portrait through their established feature owners. Verify each dialogue and portrait in-game. |
...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"dialogue-corrections","legacy_paths":[{"category":"maps-and-events","prefixes":["data/maps/FortreeCity_Gym/scripts.pory","data/maps/Route120/scripts.pory","data/maps/Route122/scripts.pory"]}],"target_paths":["data/maps/FortreeCity_Gym/scripts.inc","data/maps/Route120/scripts.inc","data/maps/Route122/scripts.inc","data/maps/NewMauville_Inside/scripts.inc","src/data/trainers.h"],"decision":"Modern adaptation","phase":2,"status":"planned","behavior":"Fortree's Gym Guide explicitly warns of Winona's Double Battle. Route 120's gate says passing requires defeating Winona. Route 122's adult-only shop speech gains paragraph breaks. Leaf's New Mauville post-battle speech asks about Red and the player's strength. Mom uses the Pokémon Breeder F battle portrait.","dependencies":["generated .inc mirrors retained by upstream-map-event-source, mom-mega-stone-challenge, v2-2-2-map-events, and historical-tooling-and-generated-material","custom-trainer-content owns src/data/trainers.h","c73e-move-animations retains data/battle_anim_scripts.s","gym-rebattle-map-integration retains data/layouts/Route118/map.bin"],"validation":["talk to Fortree Gym Guide before Winona and verify Double Battle warning","meet Route 120 gate requirement and verify Winona condition","talk to Route 122 shop NPC and verify paragraph pagination","defeat Leaf in New Mauville and verify Red-focused text","start Mom challenge and verify Pokémon Breeder F portrait","supported build"],"evidence":["git show 19b9449e16 -- data/maps/FortreeCity_Gym/scripts.pory data/maps/LittlerootTown_BrendansHouse_1F/scripts.pory data/maps/Route120/scripts.pory data/maps/Route122/scripts.pory data/text/trainers.inc src/data/trainers.h"]},
