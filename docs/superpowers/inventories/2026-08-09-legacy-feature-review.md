...
| Custom move animations and Psychic Noise effect | [`c73e-move-animations`](#feature-manifest) — battle animation scripts and move data | Current battle-animation and move-data sources | Modern adaptation | 4 | Preserve animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, and Chilling Water; preserve Psychic Noise’s Heal Block effect. Verify every animation and that Psychic Noise prevents healing. |
...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"c73e-move-animations","legacy_paths":[{"category":"gameplay-and-battle","prefixes":["data/battle_anim_scripts.s","src/data/battle_moves.h"]}],"target_paths":["data/battle_anim_scripts.s","src/data/battle_moves.h","current battle animation sources"],"decision":"Modern adaptation","phase":4,"status":"planned","behavior":"Preserve animations for Lumina Crash, Population Bomb, Ruination, Collision Course, Electro Drift, Pounce, Rage Fist, Aqua Step, Shed Tail, Tidy Up, Trailblaze, and Chilling Water; preserve Psychic Noise using the Heal Block effect.","dependencies":["current battle animation engine","current move table"],"validation":["one battle execution for each of the twelve animated moves","Psychic Noise blocks healing","supported build"],"evidence":["git show c73e48076b -- data/battle_anim_scripts.s src/data/battle_moves.h","git diff master archive/master-pre-1.16.3 -- src/data/battle_moves.h shows EFFECT_PLACEHOLDER to EFFECT_HEAL_BLOCK for Psychic Noise","c73e48076b commit message"]},
