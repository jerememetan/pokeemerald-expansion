...
<!-- feature-manifest
{
  "features": [
    ...
    {"id":"mom-mega-stone-challenge","legacy_paths":[{"category":"maps-and-events","prefixes":["data/maps/LittlerootTown_BrendansHouse_1F/scripts.inc","data/maps/LittlerootTown_BrendansHouse_1F/scripts.pory"]},{"category":"tooling-and-generated-output","prefixes":["data/scripts/players_house.inc"]},{"category":"gameplay-and-battle","prefixes":["include/constants/flags.h","include/constants/opponents.h","src/data/trainer_parties.h","src/data/trainers.h"]}],"target_paths":["data/maps/LittlerootTown_BrendansHouse_1F/**","data/scripts/players_house.inc","current flags/opponents/trainer tables"],"decision":"Modern adaptation","phase":2,"status":"planned","behavior":"Optional Mom battle awards three starter Mega Stones.","dependencies":["current Poryscript and trainer tables"],"validation":["accept/decline/repeat battle", "three reward items", "bag-full handling"],"evidence":["git show c73e48076b -- data/maps/LittlerootTown_BrendansHouse_1F/scripts.pory data/scripts/players_house.inc include/constants/flags.h include/constants/opponents.h src/data/trainer_parties.h src/data/trainers.h"]},
