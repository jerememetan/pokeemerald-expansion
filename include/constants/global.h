...
#define BAG_ITEMS_COUNT 28
#define BAG_KEYITEMS_COUNT 30
#define BAG_POKEBALLS_COUNT 16
#define BAG_TMHM_COUNT 60
#define BAG_BERRIES_COUNT 25
#define BAG_MEDICINE_COUNT 28 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_BATTLEITEMS_COUNT 28 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_TREASURES_COUNT 8 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_MEGASTONES_COUNT 47 // Needs to reduce used space in SaveBlock1 to properly use.
#define BAG_ZCRYSTALS_COUNT 18 // Needs to reduce used space in SaveBlock1 to properly use.
