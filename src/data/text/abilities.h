...
static const u8 sStenchDescription[] = _("Attacks has 10% to flinch.");
...
static const u8 sBattleArmorDescription[] = _("Blocks crits.");
static const u8 sSturdyDescription[] = _("Always live from full HP.");
static const u8 sDampDescription[] = _("Prevents self-destruction.");
static const u8 sLimberDescription[] = _("Prevents paralysis.");
static const u8 sSandVeilDescription[] = _("Ups evasion by 25% in sand.");
static const u8 sStaticDescription[] = _("30% to Paralyzes on contact.");
static const u8 sVoltAbsorbDescription[] = _("Electricity heals 1/4 HP.");
static const u8 sWaterAbsorbDescription[] = _("Water heals 1/4 HP.");
...
static const u8 sRoughSkinDescription[] = _("Deals 1/8 HP upon contact");
...
static const u8 sEffectSporeDescription[] = _("30% to status on contact.");
static const u8 sSynchronizeDescription[] = _("Passes on status problems.");
static const u8 sClearBodyDescription[] = _("Prevents stats reduction.");
static const u8 sNaturalCureDescription[] = _("Heals upon switching out.");
static const u8 sLightningRodDescription[] = _("Redirects electric moves.");
static const u8 sSereneGraceDescription[] = _("Double chance of added effects.");
...
static const u8 sIlluminateDescription[] = _("Ignores accuracy reduction");
static const u8 sTraceDescription[] = _("Copies special ability.");
static const u8 sHugePowerDescription[] = _("Doubled Attack.");
static const u8 sPoisonPointDescription[] = _("30% to Poison foe on contact.");
static const u8 sInnerFocusDescription[] = _("Prevents flinch & Intimidate");
...
static const u8 sThickFatDescription[] = _("Halves Fire and Ice attacks.");
static const u8 sEarlyBirdDescription[] = _("Awakens quickly from sleep.");
static const u8 sFlameBodyDescription[] = _("30% to Burn foe on contact.");
static const u8 sRunAwayDescription[] = _("Makes escaping easier.");
static const u8 sKeenEyeDescription[] = _("Ignores accuracy reduction");
...
static const u8 sHustleDescription[] = _("1.5x Atk but 0.8x Accuracy.");
static const u8 sCuteCharmDescription[] = _("30% to Infatuate on contact.");
static const u8 sPlusDescription[] = _("Up Sp.Atk by 50% with Minus.");
static const u8 sMinusDescription[] = _("Up Sp.Atk by 50% with Plus.");
...
static const u8 sLiquidOozeDescription[] = _("Draining moves causes injury.");
static const u8 sOvergrowDescription[] = _("1.5x Grass Atk below 1/3 HP.");
static const u8 sBlazeDescription[] = _("1.5x Fire Atk below 1/3 HP.");
static const u8 sTorrentDescription[] = _("1.5x Water Atk below 1/3 HP.");
static const u8 sSwarmDescription[] = _("1.5x Bug Atk below 1/3 HP.");
...
static const u8 sPurePowerDescription[] = _("Doubled Attack.");
...
static const u8 sUnburdenDescription[] = _("2x Speed when using an item.");
...
static const u8 sIronFistDescription[] = _("1.5x for punching moves.");
static const u8 sPoisonHealDescription[] = _("Heal 1/8 HP if poisoned.");
...
static const u8 sSolarPowerDescription[] = _("1.5x Sp.Atk in sunshine.");
static const u8 sQuickFeetDescription[] = _("1.5x Speed if suffering.");
static const u8 sNormalizeDescription[] = _("Moves become Normal-type.");
static const u8 sSniperDescription[] = _("Critical hits deal 2.25x.");
...
static const u8 sSuperLuckDescription[] = _("+1 Crit chance.");
static const u8 sAftermathDescription[] = _("Fainting deals 1/4 HP.");
...
static const u8 sTintedLensDescription[] = _("2x for resisted moves.");
static const u8 sFilterDescription[] = _("0.75x for Effective moves.");
static const u8 sSlowStartDescription[] = _("Takes 3 turns to get going.");
...
static const u8 sIceBodyDescription[] = _("Heals 1/16 HP in Snow.");
...
static const u8 sFriskDescription[] = _("Reveal foe's item.");
static const u8 sRecklessDescription[] = _("Boost recoil moves by 1.2x.");
...
static const u8 sDefeatistDescription[] = _("Gives up at 1/3 HP.");
...
static const u8 sFriendGuardDescription[] = _("Allies take 0.75x damage.");
static const u8 sWeakArmorDescription[] = _("Ups change when hit.");
...
static const u8 sToxicBoostDescription[] = _("Ups Atk & Speed if PSN.");
static const u8 sFlareBoostDescription[] = _("Ups Sp.Atk if burned.");
static const u8 sHarvestDescription[] = _("50% to recycle Berries.");
...
static const u8 sSandRushDescription[] = _("2x Speed in sandstorm.");
static const u8 sWonderSkinDescription[] = _("Status is 0.5x accurate.");
static const u8 sAnalyticDescription[] = _("1.3x damage if moved last.");
...
static const u8 sInfiltratorDescription[] = _("Ignores barriers.");
...
static const u8 sVictoryStarDescription[] = _("Allies get 1.1x accuracy.");
...
static const u8 sCheekPouchDescription[] = _("Eating Berry heals 1/3 HP.");
static const u8 sProteanDescription[] = _("Changes type to used move.");
static const u8 sFurCoatDescription[] = _("Doubled Defense.");
static const u8 sBulletproofDescription[] = _("Avoids projectiles.");
static const u8 sCompetitiveDescription[] = _("Lowered stats up Sp. Atk.");
static const u8 sStrongJawDescription[] = _("1.5x for biting moves.");
...
static const u8 sMegaLauncherDescription[] = _("1.5x for pulse moves.");
static const u8 sGrassPeltDescription[] = _("1.5x Defense in grass.");
static const u8 sSymbiosisDescription[] = _("Passes its item to an ally.");
static const u8 sToughClawsDescription[] = _("1.2x for contact moves.");
...
static const u8 sDarkAuraDescription[] = _("1.33x for Dark moves.");
static const u8 sFairyAuraDescription[] = _("1.33x for Fairy moves.");
...
static const u8 sMercilessDescription[] = _("Crits on poisoned foes.");
...
static const u8 sWaterBubbleDescription[] = _("2x for Water Moves.");
static const u8 sSteelworkerDescription[] = _("1.5x Steel moves.");
static const u8 sBerserkDescription[] = _("Boosts Sp. Atk at low HP.");
static const u8 sSlushRushDescription[] = _("2x Speed in Hail or Snow.");
...
static const u8 sSurgeSurferDescription[] = _("2x Speed in electricity.");
