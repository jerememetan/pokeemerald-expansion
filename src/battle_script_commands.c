...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_MAX_REPEL,       {   8,  30,   _,   _,   _,   _,   _,   _,   _,   _, } },
    ...
    { ITEM_RARE_CANDY,      {   3,   3,   9,   8,   9,  30,   _,   _,   _,   _, } },
    { ITEM_REVIVE,          {   3,   3,   3,   8,   8,   9,  30,   _,   _,   _, } },
    { ITEM_PP_UP,           {   3,   3,   3,   4,   8,   9,   8,  30,   _,   _, } },
    ...
    { ITEM_LINKING_CORD,    {   _,   _,   3,   4,   4,   4,   8,   8,   9,  30, } },
    { ITEM_CELL_BATTERY,    {   _,   _,   1,   1,   4,   4,   4,   _,   _,   _, } },
    { ITEM_LUMINOUS_MOSS,   {   _,   _,   1,   1,   1,   4,   4,   5,   4,   5, } },
...
#define BENEFITS_FROM_LEEK(battler, holdEffect)((holdEffect == HOLD_EFFECT_LEEK) && (GET_BASE_SPECIES_ID(gBattleMons[battler].species) == SPECIES_FARFETCHD_GALARIAN || gBattleMons[battler].species == SPECIES_SIRFETCHD))
        ...
        case MOVEEND_PROTECT_LIKE_EFFECT:
            if (gProtectStructs[gBattlerAttacker].touchedProtectLike)
            {
                ...
                else if (gProtectStructs[gBattlerTarget].burningbulwarked)
                {
                    ...
                    BattleScriptPushCursor();
                    gBattlescriptCurrInstr = BattleScript_BurningBulwarkEffect;
                    effect = 1;
                }
